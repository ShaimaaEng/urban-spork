...
<div class="yt" style="padding-top: 30px;text-align: center;">
    <p style="font-size: 20px;">تسجيل</p>
...
<br><br>
    ...
    <div class="container" style="padding-left: 40px;padding-bottom: 40px;padding-right: 40px;">
        <form action="">

            <label for="lname" style="float:right;">الاسم</label>
         <input type="text" id="fname" name="firstname" required>

            <label for="lname" style="float:right;">البريد الالكتروني</label>
            <input type="text" id="lname" name="lastname" required>

            <label for="country" style="float: right;">الرقم السري</label>
            <input type="text" id="lname" name="lastname" required>

            <label for="country" style="float: right;"> تأكيد الرقم السري</label>
            <input type="text" id="lname" name="lastname" required>

            <input type="checkbox" name="vehicle" value="Bike" style="float: right;"><span style="float: right;">أوافق علي الشروط و القوانين</span> <br><br><br>

            <input type="submit" value="تسجيل" style="float: right;background-color: darkcyan;">
        </form>
    </div>
